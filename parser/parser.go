...
import (
	...
	"github.com/jacobjedwards/poc-lang/ast"
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	...
	if prefix == nil {
		p.noPrefixParseFnsError(p.curToken.Type)
		return nil
	}
	leftExp := prefix()
...
func (p *Parser) noPrefixParseFnsError(t token.TokenType) {
...
func (p *Parser) registerPostfix(token token.TokenType, fn postfixParseFn) {
	p.postfixParseFns[token] = fn
}
